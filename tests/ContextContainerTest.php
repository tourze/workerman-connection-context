...
class ContextContainerTest extends TestCase
{
    ...
    public function testGetContextReturnsNullWhenNotSet(): void
    {
        ...
        $context = ContextContainer::getInstance()->getContext($connection, TestContext::class);
    ...
    public function testMultipleContextsPerConnection(): void
    {
        ...
        $retrievedContext1 = ContextContainer::getInstance()->getContext($connection, TestContext::class);
        $retrievedContext2 = ContextContainer::getInstance()->getContext($connection, AnotherTestContext::class);
    ...
    public function testMultipleConnectionsWithSameContextType(): void
    {
        ...
        ContextContainer::getInstance()->setContext($connection1, $context1);
        ContextContainer::getInstance()->setContext($connection2, $context2);

        $retrievedContext1 = ContextContainer::getInstance()->getContext($connection1, TestContext::class);
        $retrievedContext2 = ContextContainer::getInstance()->getContext($connection2, TestContext::class);
    ...
    public function testContextIsolationBetweenConnections(): void
    {
        ...
        ContextContainer::getInstance()->setContext($connection1, $context);

        $retrievedFromConn1 = ContextContainer::getInstance()->getContext($connection1, TestContext::class);
        $retrievedFromConn2 = ContextContainer::getInstance()->getContext($connection2, TestContext::class);
